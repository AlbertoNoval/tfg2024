...
public class Node : MonoBehaviour
{
    ...
    [SerializeField] private HashSet<Transform> neighbourNode = new HashSet<Transform>();
    ...
    public HashSet<Transform> getNeighbourNode()
    {
        HashSet<Transform> result = this.neighbourNode;
        return result;
    }
